module.exports = (robot) ->
  robot.hear /おはよう/, (msg) ->
    msg.send msg.random ["@#{msg.message.user.name} おはよう！ あんず、今日は頑張れる気がするよ！", "@#{msg.message.user.name} おはよう、プロデューサー", "@#{msg.message.user.name} んー、おはよー", "@#{msg.message.user.name} おはよっ！", "@#{msg.message.user.name} おはよ〜、ん〜、あんず、ちょっとまだ眠い..."]
